...
profile_plot <- function(mydir, model_settings, rep, vec, para, profilesummary){
  ...
  pngfun(wd = mydir, file = file.path(mydir, paste0("piner_panel_", para, ".png")), h= 7, w = 7)
  par(mfrow = c(2,2))
  ...
  pngfun(wd = mydir, file = file.path(mydir, paste0("parameter_panel_", para, ".png")), h = 7, w = 7)
  par(mfrow = c(2,2))
